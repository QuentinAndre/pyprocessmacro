...
class LogitOutcomeModel(BaseOutcomeModel, BaseLogit):
    ...
    def __init__(self, data: ndarray, endogvar: str, exogvars: List[str], symb_to_ind: Dict[str, int],
                 symb_to_var: Dict[str, str], options: Optional[Dict[str, Any]] = ...) -> None: ...
